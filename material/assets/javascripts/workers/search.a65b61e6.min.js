 ...
 */t.stemmer=function(){var e={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},r={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},n="[^aeiou]",i="[aeiouy]",s=n+"[^aeiouy]*",o=i+"[aeiou]*",a="^("+s+")?"+o+s,u="^("+s+")?"+o+s+"("+o+")?$",c="^("+s+")?"+o+s+o+s,h="^("+s+")?"+i,y=new RegExp(a),g=new RegExp(c),w=new RegExp(u),m=new RegExp(h),Q=/^(.+?)(ss|i)es$/,f=/^(.+?)([^s])s$/,p=/^(.+?)eed$/,L=/^(.+?)(ed|ing)$/,b=/.$/,E=/(at|bl|iz)$/,O=new RegExp("([^aeiouylsz])\\1$"),j=new RegExp("^"+s+i+"[^aeiouwxy]$"),C=/^(.+?[^aeiou])y$/,A=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,$=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,D=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,V=/^(.+?)(s|t)(ion)$/,P=/^(.+?)e$/,N=/ll$/,B=new RegExp("^"+s+i+"[^aeiouwxy]$"),M=function(l){var v,I,k,d,x,R,F;if(l.length<3)return l;if(k=l.substr(0,1),k=="y"&&(l=k.toUpperCase()+l.substr(1)),d=Q,x=f,d.test(l)?l=l.replace(d,"$1$2"):x.test(l)&&(l=l.replace(x,"$1$2")),d=p,x=L,d.test(l)){var S=d.exec(l);d=y,d.test(S[1])&&(d=b,l=l.replace(d,""))}else if(x.test(l)){var S=x.exec(l);v=S[1],x=m,x.test(v)&&(l=v,x=E,R=O,F=j,x.test(l)?l=l+"e":R.test(l)?(d=b,l=l.replace(d,"")):F.test(l)&&(l=l+"e"))}if(d=C,d.test(l)){var S=d.exec(l);v=S[1],l=v+"i"}if(d=A,d.test(l)){var S=d.exec(l);v=S[1],I=S[2],d=y,d.test(v)&&(l=v+e[I])}if(d=$,d.test(l)){var S=d.exec(l);v=S[1],I=S[2],d=y,d.test(v)&&(l=v+r[I])}if(d=D,x=V,d.test(l)){var S=d.exec(l);v=S[1],d=g,d.test(v)&&(l=v)}else if(x.test(l)){var S=x.exec(l);v=S[1]+S[2],x=g,x.test(v)&&(l=v)}if(d=P,d.test(l)){var S=d.exec(l);v=S[1],d=g,x=w,R=B,(d.test(v)||x.test(v)&&!R.test(v))&&(l=v)}return d=N,x=g,d.test(l)&&x.test(l)&&(d=b,l=l.replace(d,"")),k=="y"&&(l=k.toLowerCase()+l.substr(1)),l};return function(_){return _.update(M)}}(),t.Pipeline.registerFunction(t.stemmer,"stemmer");/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
